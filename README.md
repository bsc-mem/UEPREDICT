...
| -ru    | --random-undersampling    | Ratio of the number of samples in the minority class over the number of samples in the majority class after resampling. The ratio is expressed as *N<sup>m</sup>/N<sup>rM</sup>*, where *N<sup>m</sup>* is the number of samples in the minority class and *N<sup>rM</sup>* is the number of samples in the majority class after resampling. If the ratio is 0, do not sample.                                                                                     |
